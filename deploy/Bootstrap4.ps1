...
Set-Content -LiteralPath $Log -Value "=== StandRise bootstrap v4 $(Get-Date) ===" -Encoding UTF8
...
$verOut = & $mongod --version 2>&1 | Select-Object -First 3
$verOut | ForEach-Object { L "  $_" }
